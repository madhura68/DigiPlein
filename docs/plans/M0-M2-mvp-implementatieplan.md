...
│   ├── avg.ts                      # notitie-instructie + VERBODEN_VELDEN — één AVG-bron (ST-102/103/202)
│   └── chat/guardrails.ts          # checkProposal() o.b.v. lib/avg.ts (ST-202)
...
| **S-M1** — "M1 Vier kerntabellen: volledig beheer met AVG-by-design" | "M1 — De vier tabellen" (prio 1) | ST-101 t/m ST-107 (sort_order 1–7) | 2–4 per story, conform §3; plus één losse taak **hostingbesliskaart** (A2: Vercel+Neon vs. eigen server) onder ST-107 |
